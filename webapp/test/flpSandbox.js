		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Help Document List",
									"targetURL": "#comztcsaphelpdocumentzhelpdocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comztcsaphelpdocumentzhelpdocument-display": {
								"semanticObject": "comztcsaphelpdocumentzhelpdocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ztcsap.helpdocument.zhelpdocument",
									"url": sap.ui.require.toUrl("com/ztcsap/helpdocument/zhelpdocument")
								}
							}
						}
					}
